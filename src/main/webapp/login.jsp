...
<html lang="en" data-astro-cid-sckkx6r4>
  ...
  <body data-astro-cid-sckkx6r4>
    <div class="login-page">
      <div
        class="twocolumns-component"
        style="
          --flexDirection: row;
          --directionLeft: 0;
          --directionRight: auto;
          --bgimage: [object Object];
        "
      >
        <div class="container-component" data-astro-cid-d6puh33w>
          <div
            class="twocolumns-component-left"
            style="
              --flexDirection: row;
              --directionLeft: 0;
              --directionRight: auto;
          ...
          >
            <div class="panel-component" data-astro-cid-u23vcbo2>
		        ...
		        <% } %>
              <form class="form" action="login" method="post" data-astro-cid-kl5b6njz>
                <h3
                  class="main-title"
                ...
                <div class="form-group" data-astro-cid-atrthr4o>
                  <label data-astro-cid-atrthr4o>
                    <span data-astro-cid-atrthr4o>Usuario:</span>
                    <input
                      class="form-control"
                      type="text"
                      name="username"
                      placeholder="Ingresa tu usuario"
                      data-astro-cid-kl5b6njz="true"
                ...
                <div class="form-group" data-astro-cid-atrthr4o>
                  <label data-astro-cid-atrthr4o>
                    <span data-astro-cid-atrthr4o>Contraseña:</span>
                    <input
                      class="form-control"
                      type="password"
                      name="password"
                      placeholder="Ingresa tu Contraaseña"
                      data-astro-cid-kl5b6njz="true"
                      data-astro-cid-atrthr4o
                    />
                    <span class="form-error" data-astro-cid-atrthr4o></span>
                ...
                <button
                  class="simple-button btn default block"
                  data-astro-cid-quglckyz
                >
            ...
            <div class="options">
              ¿No tiene una cuenta? |
              <a href="#" class="btn">Registrate aquí</a>
            </div>
          </div>
          <div
            class="twocolumns-component-right"
            style="
              --flexDirection: row;
              --directionLeft: 0;
              --directionRight: auto;
          ...
          >
            ...
            >
              <img
                src="dist/_astro/aparcamiento.Dl2qS3Nq_Z2sfHeG.webp"
                alt="background"
                loading="lazy"
                decoding="async"
                fetchpriority="auto"
            ...
            >
              ...
              <h1>
                Encuentra y reserva tu espacio fácilmente antes de llegar.
              </h1>
            </div>
          </div>
        </div>
